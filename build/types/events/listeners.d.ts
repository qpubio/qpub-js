 ...
 */
import type { ConnectionEventPayloads, ChannelEventPayloads, AuthEventPayloads } from "./payloads";
/**
 ...
 */
export type ConnectionEventListener<K extends keyof ConnectionEventPayloads> = (payload: ConnectionEventPayloads[K]) => void;
/**
 * Type-safe channel event listener
 * Usage: on('subscribed', (payload) => { ... })
 */
export type ChannelEventListener<K extends keyof ChannelEventPayloads> = (payload: ChannelEventPayloads[K]) => void;
/**
 * Type-safe auth event listener
 * Usage: on('token_updated', (payload) => { ... })
 */
export type AuthEventListener<K extends keyof AuthEventPayloads> = (payload: AuthEventPayloads[K]) => void;
/**
